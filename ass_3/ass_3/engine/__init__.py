...
class Engine:
    ...
    # engine_costs = [4 if 1 <= j <= 20 else 3 if 21 <= j <= 30 else 2 if 31 <= j <= 45 else 5 if 46 <= j <= 80 else 6 for j in range(1, 100+1)]
    # rul = pd.read_csv('ass_3/data/RUL_consultancy_predictions_A3-2.csv', sep = ";")['RUL'].tolist()
